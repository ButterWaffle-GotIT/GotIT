    ...
    <div className="glass flex w-full flex-col gap-8 rounded-3xl bg-white/10 px-9 py-10">
      <div className="flex items-center justify-between">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 top-full mt-2 flex w-30 flex-col overflow-hidden rounded-lg border border-gray-700 bg-gray-900 z-50">
              <button
                className="px-4 py-3 text-left text-body4 text-gray-50 hover:bg-gray-800 transition-colors"
                onClick={() => {
                  setSortType("latest");
                  setIsDropdownOpen(false);
                }}
